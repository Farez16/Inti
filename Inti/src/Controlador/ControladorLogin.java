...
public class ControladorLogin implements ActionListener {
    ...
    public ControladorLogin(Login vista) {
        ...
        this.vista.btnIniciarGoogle.addActionListener(this);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource() == vista.btnInicar) {
            iniciarSesion();
        } else if (e.getSource() == vista.btnIniciarGoogle) {
            iniciarConGoogle();
...
private void abrirCambioContrasena(String correo) {
    ...
    JDialog dialog = new JDialog(vista, "Cambiar contraseña", true);
    dialog.setContentPane(panelCambio);
    dialog.pack();
    dialog.setLocationRelativeTo(vista);

    new ControladorContrasenaNueva(vista, correo, dialog);
